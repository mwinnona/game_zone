            ...
            <div class="col-md-3">
                <div class="product-details">
                    <div class="add-to-cart centrar-interno">
                        <a onclick="alert('¿Estas seguro de eliminar estos juegos del carrito?')"><button type="submit" class="add-to-cart-btn"><i class="fa fa-close"></i>Eliminar Seleccionados</button></a>
                    </div>
                </div>
                <div class="product-details">
                    <div class="add-to-cart centrar-interno">
